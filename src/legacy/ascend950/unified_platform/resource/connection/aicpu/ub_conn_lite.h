...
public:
    ...
    void FillBatchOneWqe(const RmaBufSliceLite &loc, const RmtRmaBufSliceLite &rmt, bool isLastWqe,
                         const UdmaSqeWrite &sqeTemplate, const StreamLite &stream);

    void BatchProcessOneSlice(const RmaBufSliceLite &loc, const RmtRmaBufSliceLite &rmt, u32 maxSliceSize,
