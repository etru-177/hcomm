...
Rank table文件是一个JSON格式的文件，配置了参与集合通信的NPU资源信息，关于rank table文件的配置可参见[集群信息配置](https://gitcode.com/cann/hccl/blob/9.1.0/docs/zh/user_guide/cluster_info_config/README.md)。
