...
| `CCU_E_DRV_*` | 驱动层错误，当前可能返回 4097（`CCU_E_DRV_INIT_FAILED`）或 4098（`CCU_E_DRV_BUSY`）；驱动层错误码段定义于 [`CCU_E_DRV_START`=4096, `CCU_E_DRV_END`=4224]，详见 [CcuResult](../../datatype_definition/CcuResult.md)。 |
