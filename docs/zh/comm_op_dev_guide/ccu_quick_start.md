...
开发者可以点击[CCU样例](https://gitcode.com/cann/hccl/tree/9.1.0/examples/05_custom_ops_allgather/ccu)获取完整样例代码，该样例使用HCCL通信算子开发接口实现了基于CCU通信引擎的AllGather算子，主要实现流程如下所示：
